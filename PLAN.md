...
- Baseline (buy nothing): **0/8 survive, median eviction ~11-13** — the
  ...
  6–20+. Combined tree (job board + needs drag + T1 + boat + T2 thirst,
  2026-08-18): 0/8, evictions 8-14, median 11 (16 seeds: 8-18, median 13).
...
- `node tools/suite.mjs` — **38 scenarios, must stay green before any push.**
